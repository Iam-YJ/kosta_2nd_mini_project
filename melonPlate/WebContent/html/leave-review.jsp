...
<body>
	...
	<!-- /header -->
	<form name="writeForm" method="post" action="${pageContext.request.contextPath}/dispatcher?key=reply&methodName=insertReply&res_no=1&user_no=1" 
		   ...
		   <div class="row justify-content-center">
				<div class="col-lg-8">
					<div class="box_general write_review">
						...
						<input type=submit class="btn_1" value=작성> 
					</div>
				</div>
		</div>
		<!-- /row -->
