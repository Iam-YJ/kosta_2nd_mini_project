...
<head>
    ...
    <!-- SPECIFIC CSS -->
    <link href="${pageContext.request.contextPath}/html/css/about.css" rel="stylesheet">
...
<body class="fixed-nav sticky-footer" id="page-top">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-default fixed-top" id="mainNav">
        <a class="navbar-brand" href="index.html"><img src="${pageContext.request.contextPath}/html/img/logo.svg" data-retina="true" alt="" width="142" height="36"></a>
