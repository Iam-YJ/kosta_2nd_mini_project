	...
	<nav class="navbar navbar-expand-lg navbar-dark bg-default fixed-top"
		...
		<div class="collapse navbar-collapse" id="navbarResponsive">
			<ul class="navbar-nav navbar-sidenav" id="exampleAccordion">
				...
				<li class="nav-item" data-toggle="tooltip" data-placement="right"
					title="Messages"><a class="nav-link" href="messages.jsp">
				...
				<li class="nav-item" data-toggle="tooltip" data-placement="right"
					...
					href="bookings.jsp"> <i class="fa fa-fw fa-calendar-check-o"></i>
...
<style>
table {
	width: 400px; height: 100px; border: 5px solid gray;
	margin: auto;
} 
...
<script type="text/javascript">
	var today = new Date();
	var mfd = new Date(today.getFullYear(), today.getMonth(), 1);
	var endDays = new Array (31, 29, 31, 30, 31, 30, 31, 31, 30, 31, 30, 31);
	...
	for(var i=0; i<week; i++){
		...
		for(var j=0; j<7; j++){
			...
			if(start < mfd.getDay()){
           		...
           		document.write("<a href='#' onclick='imgInsert()' id='cal'>"+date)
...
>>>>>>> branch 'master' of https://github.com/Iam-YJ/kosta_2st_mini_project.git
    </div>
				...
				<div class="col-md-6">
					<div class="box_general padding_bottom">
						<div class="agree">
							<h5>Interests</h5>
							<form action="${pageContext.request.contextPath}/dispatcher?key=user&methodName=interestInsert"
								method="post">
								<!-- .agree -->
								<ul>
