...
<head>
    ...
    <!-- SPECIFIC CSS -->
    <link href="${pageContext.request.contextPath}/html/css/review.css" rel="stylesheet">
...
<body>
	...
	<header class="header_in clearfix">
		...
		<div id="logo">
			<a href="index.html">
				<img src="html/img/logo_sticky.svg" width="140" height="35" alt="">
			</a>
		</div>
		<ul id="top_menu">
	...
	<!-- /header -->
	<form name="writeForm" method="post" action="../dispatcher?key=reply&methodName=updateReply&res_no=${reply.resNo}&user_no=${reply.userNo}" 
		   ...
		   <div class="row justify-content-center">
				<div class="col-lg-8">
					<div class="box_general write_review">
						<h1 class="add_bottom_15">Write a review for ${reply.resName}</h1>

						<label class="d-block add_bottom_15">Overall rating</label>
						<div class="row">
							<div class="col-md-3 add_bottom_25">
							   <div class="add_bottom_15">Grade <strong class="food_quality_val"></strong></div>
			                   <input type="range" min="0" max="5" step="1" value="${reply.repGrade}" data-orientation="horizontal" id="food_quality" name="food_quality">
							</div>
						</div>
						...
						<div class="form-group">
							...
							<textarea class="form-control" style="height: 180px;" name="review_content" >${reply.repContent}</textarea>
						</div>
						<div class="form-group">
						...
						<input type=submit class="btn_1" value=수정> 
					</div>
				</div>
		</div>
		<!-- /row -->
